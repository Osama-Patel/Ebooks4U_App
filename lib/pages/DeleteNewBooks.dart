...
class deleteNewBooks extends StatefulWidget {
  const deleteNewBooks({super.key});

  @override
  State<deleteNewBooks> createState() => _deleteNewBooksState();
}

class _deleteNewBooksState extends State<deleteNewBooks> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Delete New Books'),
        centerTitle: true,
        //  backgroundColor: Colors.blue,
      ),
      body: StreamBuilder<QuerySnapshot>(
        stream: _firestore.collection('New_Books').snapshots(),
